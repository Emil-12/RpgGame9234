...
void World::location3()
{
	...
	if (strcmp(hero.choise1, "1") == 0)
	{
		...
		std::cout << "Что вы выберите 1 - вернутся в свои покои или 2 - рапросить кого нибудь о вашем загадочном собеседнике" << std::endl;
	}
	else if (strcmp(hero.choise1, "2") == 0)
	{
		std::cout << "Вы возвращайтесь в свои покои, но тот взгляд не выходит из вашей головы" << std::endl;
		location4();
	}
	std::cin >> hero.choise1;
	if (strcmp(hero.choise1, "1") == 0)
