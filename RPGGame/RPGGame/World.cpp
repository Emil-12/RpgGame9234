...
void World::location1()
{
	...
	std::cout << "Чтобы начать нажмите - 1 или 2 - чтобы выйти в меню" << std::endl;
...
void World::location3()
{
	...
	else if (strcmp(hero.choise1, "2") == 0)
	{
		...
		std::cout << "Что вы выберите:\n1 - поговорить с этим горожанином" << std::endl;
	}
	std::cin >> hero.choise1;
	if (strcmp(hero.choise1, "1") == 0)
	{
		...
		std::cout << "З.г - в ближайшее время узнайте..." << std::endl;
		std::cout << "Вас толкают в сторону и когда вы оборочивайтесь, того горожанина и след простыл" << std::endl;
		std::cout << "Нажмите 1 - вернутся в свои покои" << std::endl;
	}
	std::cin >> hero.choise1;
	if (strcmp(hero.choise1, "1") == 0)
	{
